...
## 7. Example — TargetCancer Foundation seed

`tools/classify-tcf.js` merges a proposed Series/Audience/Topic map into the
harvested `tcf-videos.json` to produce `tcf-videos-classified.json` (52 videos).
